...
import {
  ...
  /** Contract rounds supported by the ABI (enum RoundType { Private, Institutional, Community }) */
  ...
  export async function readRoundMaxTokensRaw(key: RoundKey): Promise<bigint> {
    ...
    return info[8]; // maxTokensToSell_
  }
  ...
  export async function setRoundMaxTokensHumanTx(
    ...
    return await setRoundMaxTokensRawTx(account, key, raw);
  }
